...
const { Characters } = require('../db/schemas.js');
...
const connectDB = async () => {
  try {
    ...
    var array = [];
    var counter = 0;
    const stream = fs.createReadStream('/Users/Zhaowei/rpp34/elt_data_sdc/characteristic_reviews.csv')
      ...
      .on('data', async (row) => {
        try {
          ...
          if (array.length === 10000) {
            ...
            */
            stream.pause();
            await Characters.insertMany(array);
